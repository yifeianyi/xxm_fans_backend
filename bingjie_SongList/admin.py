...
@admin.register(bingjie_Songs)
class bingjie_SongsAdmin(admin.ModelAdmin):
...
@admin.register(bingjie_site_setting)
class bingjie_site_settingAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if 'photoURL' in request.FILES:
            ...
            # 确保目录存在
            frontend_photos_dir = os.path.join(settings.BASE_DIR, 'bingjie_SongList_frontend', 'photos')
            ...
            # 同时复制到public目录
            public_dir = os.path.join(settings.BASE_DIR, 'bingjie_SongList_frontend', 'public')
